...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _value
    ) public onlyPayloadSize(3 * 32) override virtual returns (bool) {
        require(_to != address(0));
...
abstract contract UpgradedStandardToken is StandardToken {
    ...
    function destroyBlackFundsByLegacy(address _blackListedUser) public virtual;
}

contract MMMM is Pausable, StandardToken, BlackList {
    string public name;
